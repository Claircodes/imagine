...
.k-link, tr {
	...
	<script>
		...
		$("#goodsGrid tbody > tr").dblclick(function(){
	...
	<kendo:grid title="상품리스트" name="goodsGrid" pageable="true" sortable="true" scrollable="true" height="450" navigatable="true">
		...
		<kendo:grid-excel fileName="회사정보.xlsx" allPages="true" filterable="true" proxyURL="${eUrl}" />
