...
public class DbInfoController {
	...
	@RequestMapping(value="/db/table/info/list",method=RequestMethod.POST)
	public @ResponseBody List<Column> getTableInfoList(@RequestBody Column c){
		return ds.getColumnList(c);
	}
}
